...
<div class="detail">
    <div class="info_detail">
        <div class="row g-0 info-line">
            ...
            <section class="col text-center text-uppercase"><label>Khu Vực: </label><?php echo $account['khuvuc'] ?></section>
            <section class="col text-center"><label>Tướng: </label> <?php echo $account['soluongtuong'] ?> </section>
        </div>

        <img class="img-detail" src="../../../public/asset/img/<?php echo $account['img'] ?>" alt="">
    </div>
