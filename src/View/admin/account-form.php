    ...
    <div class="col-md-9">
        <div class="card mb-5">
            <div class="card-header">
                <span class="fs-5 fw-bolder">Chỉnh sửa thông tin account</span>
            </div>
            <div class="card-body">
                <form action="/admin/account-form/<?= $account['acc_id'] ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="level" class="form-label">Level</label>
                        <input type="number" class="form-control" id="level" name="level" value="<?= $account['level'] ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="amountWeapon" name="amountWeapon" value="<?= $account['soluongvukhi'] ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="cost" name="cost" value="<?= $account['gia'] ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="taikhoan" name="taikhoan" value="<?= $account['taikhoan'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">Mật khẩu:</label>
                        <input type="text" class="form-control" id="password" name="password" value="<?= $account['matkhau'] ?>" required>
                    </div>
                    <div class="mb-3">
